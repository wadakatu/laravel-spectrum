...
class QueryParameterAnalyzerTest extends TestCase
{
    ...
    public function testDetectsArrayTypeFromContext(): void
    {
        $controller = new class {
    ...
    public function testHandlesStaticRequestCalls(): void
    {
        $controller = new class {
    ...
    public function testHandlesComplexUsagePatterns(): void
    {
    ...
    public function testGeneratesDescriptionsFromParameterNames(): void
    {
        $controller = new class {
