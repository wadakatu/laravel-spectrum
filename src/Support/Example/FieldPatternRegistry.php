...
final class FieldPatternRegistry
{
     ...
     *
     * @var array<string, array{type: string, format: ?string, fakerMethod: ?string, fakerArgs: array, staticValue: mixed}>
     */
     ...
     *
     * @return array<string, array{type: string, format: ?string, fakerMethod: ?string, fakerArgs: array, staticValue: mixed}>
     */
     ...
     * @return array{type: string, format: ?string, fakerMethod: ?string, fakerArgs: array, staticValue: mixed}|null
     */
    private function matchSuffixPrefixPatterns(string $fieldName): ?array
    {
